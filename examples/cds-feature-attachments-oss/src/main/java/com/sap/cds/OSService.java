...
/**
 * The {@link OSService} is the connection to the storage for attachments.
 */
public interface OSService extends Service {

	/**
	 * The {@link OSService} wrapping the primary attachment storage uses this name
	 */
	String DEFAULT_NAME = "OSService$Default";
	 ...
	 * @throws ServiceException Exception to be thrown in case of errors during accessing the attachment
	 */
	AttachmentModificationResult createAttachment(InputStream input);
