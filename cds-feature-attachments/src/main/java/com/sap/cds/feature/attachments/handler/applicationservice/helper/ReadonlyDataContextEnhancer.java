...
public final class ReadonlyDataContextEnhancer {
	...
	/**
	 * Backs up the readonly fields of an attachment in the given data in a custom field with the name
	 ...
	 */
	public static void backupReadonlyFields(CdsEntity target, List<CdsData> data, boolean isDraft) {
