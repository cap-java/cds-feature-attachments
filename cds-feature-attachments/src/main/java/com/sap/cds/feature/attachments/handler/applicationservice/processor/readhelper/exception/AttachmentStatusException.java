...
public class AttachmentStatusException extends ErrorStatusException {
	...
	public static AttachmentStatusException getNotCleanException() {
		return new AttachmentStatusException(AttachmentErrorStatuses.NOT_CLEAN, AttachmentErrorStatuses.NOT_CLEAN.getDescription());
	}

	public static AttachmentStatusException getNotScannedException() {
		return new AttachmentStatusException(AttachmentErrorStatuses.NOT_SCANNED, AttachmentErrorStatuses.NOT_SCANNED.getDescription());
	}
