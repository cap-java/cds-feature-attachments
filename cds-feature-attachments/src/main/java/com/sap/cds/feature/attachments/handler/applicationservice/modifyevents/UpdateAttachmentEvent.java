...
/**
 * The class {@link UpdateAttachmentEvent} is an implementation of the {@link
 * ModifyAttachmentEvent}. The class is used to update an attachment by calling the mark as deleted
