...
public enum AttachmentErrorStatuses implements ErrorStatus {
	...
	NOT_CLEAN("not_clean", "Attachment is not clean", ErrorStatuses.METHOD_NOT_ALLOWED), NOT_SCANNED("not_scanned",
			"Attachment is not scanned, try again in a few minutes", ErrorStatuses.METHOD_NOT_ALLOWED);
