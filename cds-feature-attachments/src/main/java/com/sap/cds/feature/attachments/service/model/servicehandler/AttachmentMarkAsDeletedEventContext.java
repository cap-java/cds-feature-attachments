...
public interface AttachmentMarkAsDeletedEventContext extends EventContext {
  ...
  /**
   * @return The user information of the user which triggers the deletion of the attachment or
   *     {@code null} if no user information was specified
   */
   ...
   *
   * @param deletionUserInfo The user information of the user which triggers the deletion of the
   *     attachment
   */
