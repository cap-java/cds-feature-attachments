...
public interface AttachmentService extends Service {
	...
	/**
		...
		* 		- isInternalStored - shows if the content was stored internally, this does not indicate errors, in case of errors ServiceException is thrown
		* 		- contentId - id of the stored content
		* @throws com.sap.cds.services.ServiceException Exception to be thrown in case of errors during accessing the attachment
		*/
	...
	/**
		...
		*
		* @param restoreTimestamp The timestamp from which the documents shall be restored, every content which was deleted after or equal this timestamp shall be restored
