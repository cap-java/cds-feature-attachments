...
public interface AttachmentService extends Service {
   ...
   * @throws ServiceException Exception to be thrown in case of errors during accessing the
   *     attachment
   */
   ...
   *     <ul>
   *       <li>isInternalStored - shows if the content was stored internally, this does not indicate
   *           errors, in case of errors ServiceException is thrown
   *       <li>contentId - id of the stored content
   *     </ul>
   *
   * @throws ServiceException Exception to be thrown in case of errors during accessing the
   *     attachment
  ...
  /**
   * Marks an attachment as deleted based on the given attachment id The attachment will not be
   * deleted physically, but marked as deleted
   *
   * @param input Contains the content id of the content which shall be deleted and the user input
   *     of the user which created the deletion request
   * @throws ServiceException Exception to be thrown in case of errors during accessing the
   *     attachment
   */
   ...
   *
   * @param restoreTimestamp The timestamp from which the documents shall be restored, every content
   *     which was deleted after or equal this timestamp shall be restored created documents after
   *     this timestamp needs to be mark as deleted
