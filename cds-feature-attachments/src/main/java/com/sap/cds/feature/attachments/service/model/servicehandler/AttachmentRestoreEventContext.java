...
/**
 * The {@link AttachmentRestoreEventContext} is used to store the context of the restore deleted
 * attachment event.
 */
...
public interface AttachmentRestoreEventContext extends EventContext {
  ...
  /**
   * @return The restore timestamp for the contents to be restored or {@code null} if no timestamp
   *     was specified
   */
   ...
   *
   * @param restoreTimestamp The timestamp from which the contents shall be restored, every content
   *     which was deleted after or equal this timestamp will be restored
   */
