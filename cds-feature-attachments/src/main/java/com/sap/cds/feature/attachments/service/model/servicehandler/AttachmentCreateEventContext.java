...
/**
 * The {@link AttachmentCreateEventContext} is used to store the context of the create attachment
 * event.
 */
...
public interface AttachmentCreateEventContext extends EventContext {
  ...
  /**
   * Sets the attachment entity for the attachment storage The name of this entity can be used e.g.
   * to access the data using the persistence service
   *
