...
class NodeTreeTest {
  ...
  void addPathWithComplexPathTable() {
    ...
    AssociationIdentifier identifier2 =
        new AssociationIdentifier("associationName2", "fullEntityName2");
    AssociationIdentifier identifier3 =
        new AssociationIdentifier("associationName3", "fullEntityName3");
  ...
  void addComplexPathWithMultipleChildren() {
    ...
    AssociationIdentifier identifier3 =
        new AssociationIdentifier("associationName3", "fullEntityName3");
    AssociationIdentifier identifier4 =
        new AssociationIdentifier("associationName4", "fullEntityName4");
    ...
    assertThat(cut.getChildren().get(0).getChildren().get(0).getIdentifier())
        .isEqualTo(identifier3);
    ...
    assertThat(cut.getChildren().get(1).getChildren().get(0).getIdentifier())
        .isEqualTo(identifier4);
    ...
    assertThat(cut.getChildren().get(2).getChildren().get(0).getIdentifier())
        .isEqualTo(identifier2);
    assertThat(cut.getChildren().get(2).getChildren().get(0).getChildren()).hasSize(1);
    assertThat(cut.getChildren().get(2).getChildren().get(0).getChildren().get(0).getIdentifier())
        .isEqualTo(identifier3);
    assertThat(cut.getChildren().get(2).getChildren().get(0).getChildren().get(0).getChildren())
        .isNotNull()
        .isEmpty();

    assertThat(cut.getChildren().get(2).getChildren().get(1).getIdentifier())
        .isEqualTo(identifier4);
  ...
  private void verifyTwoNodeHierarchies(
      NodeTree cut, AssociationIdentifier identifier2, AssociationIdentifier identifier3) {
