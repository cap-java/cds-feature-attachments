...
class AttachmentErrorStatusesTest {
  ...
  void notCleanCodeHasCorrectProperties() {
    ...
    assertThat(AttachmentErrorStatuses.NOT_CLEAN.getDescription())
        .isEqualTo("Attachment is not clean");
  ...
  void notScannedCodeHasCorrectProperties() {
    ...
    assertThat(AttachmentErrorStatuses.NOT_SCANNED.getDescription())
        .isEqualTo("Attachment is not scanned, try again in a few minutes");
